-- 適用状況: 開発環境(preview/public) 適用済み（2026-08-20 確認） / 本番 2026-09-03
-- =====================================================================
-- v_juchu_kizai_head_lst 変更前定義（ロールバック用バックアップ）
--
-- 取得元 : ステージング Supabase プロジェクト jimqcvyaoddsxbcrsnfs / public スキーマ
-- 取得日 : 2026-08-20（適用直前）
-- 取得方法: SELECT pg_get_viewdef('public.v_juchu_kizai_head_lst', true)
-- reloptions: ["security_invoker=on"]
--
-- 用途: v_juchu_kizai_head_lst.sql を適用したあとに問題が出た場合、
