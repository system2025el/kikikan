...
export const selectNyushukoDetail = async (
  ...
  try {
    return await supabase
      ...
      .select(
        'juchu_head_id, juchu_kizai_head_id, juchu_kizai_meisai_id, juchu_kizai_head_kbnv, head_namv, kizai_id, kizai_nam, koen_nam, koenbasho_nam, kokyaku_nam, nyushuko_basho_id, nyushuko_dat, nyushuko_shubetu_id, plan_qty, result_adj_qty, result_qty, sagyo_kbn_id, ctn_flg, dsp_ord_num_meisai, indent_num, mem2'
      )
