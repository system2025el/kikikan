...
export const selectJuchuKizaiNyushuko = async (juchuHeadId: number, juchuKizaiHeadId: number) => {
  try {
    ...
    throw new Error('[selectJuchuKizaiNyushuko] DBエラー:', { cause: e });
  }
};
...
export const selectOyaJuchuKizaiNyushukoConfirm = async (
  ...
  try {
    ...
    throw new Error('[selectOyaJuchuKizaiNyushukoConfirm] DBエラー:', { cause: e });
  }
};
...
export const insertJuchuKizaiNyushuko = async (data: JuchuKizaiNyushuko, connection: PoolClient) => {
  ...
  try {
    ...
    throw new Error('[insertJuchuKizaiNyushuko] DBエラー:', { cause: e });
  }
};
...
export const updateJuchuKizaiNyushuko = async (data: JuchuKizaiNyushuko, connection: PoolClient) => {
  ...
  try {
    ...
    throw new Error('[updateJuchuKizaiNyushuko] DBエラー:', { cause: e });
  }
};
...
export const deleteJuchuKizaiNyushuko = async (
  ...
  try {
    ...
    throw new Error('[deleteJuchuKizaiNyushuko] DBエラー:', { cause: e });
  }
};
...
export const deleteJuchuKizaiNyushukoFromOrder = async (
  ...
  try {
    ...
    throw new Error('[deleteJuchuKizaiNyushukoFromOrder] DBエラー:', { cause: e });
  }
};
