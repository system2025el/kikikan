 ...
 */
export const Bill = ({ user, isNew, bill }: { user: User; isNew: boolean; bill: BillHeadValues }) => {
            ...
            >
              ...
              <AccordionDetails sx={{ padding: 0 }}>
                ...
                <Grid2 container direction={'column'} spacing={1} my={1}>
                  ...
                  <Grid2 sx={styles.container}>
                    <Typography marginRight={1}>請求先住所（郵便番号）</Typography>
                    <TextFieldElement name="adrPost" control={control} sx={{ width: 100 }} disabled={!editable} />
                  </Grid2>
                  <Grid2 sx={styles.container}>
