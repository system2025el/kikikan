  ...
  const onSubmit = async (data: { resultAdjQty: number }) => {
    if (user && !isProcessing) {
      ...
      if (updateResult) {
        ...
        router.push(
          `/nyuko-list/nyuko-detail/${nyukoEqptDetailData.juchuHeadId}/${nyukoEqptDetailData.juchuKizaiHeadKbnId}/${nyukoEqptDetailData.nyushukoBashoId}/${new Date(nyukoEqptDetailData.nyushukoDat).toISOString()}/${nyukoEqptDetailData.sagyoKbnId}`
        );
      } else {
