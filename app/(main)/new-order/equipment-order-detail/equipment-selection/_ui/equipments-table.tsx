...
import { eqCategories, eqData, eqList } from '../_lib/data';
...
type EnhancedTableProps = {
  numSelected: number;
  onRequestSort: (event: React.MouseEvent<unknown>, property: keyof eqData) => void;
...
const EnhancedTableHead = (props: EnhancedTableProps) => {
  ...
  const createSortHandler = (property: keyof eqData) => (event: React.MouseEvent<unknown>) => {
